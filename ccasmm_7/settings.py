"""
Django settings for ccasmm_7 project.
...
WSGI_APPLICATION = 'ccasmm_7.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ccasmm_7 API",
    "DESCRIPTION": "API documentation for ccasmm_7 App",
    "VERSION": "v1",
}
